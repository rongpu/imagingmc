...
tmp_dir = '/pscratch/sd/r/rongpu/imaging_mc/tmp5/'
...
hp_table.write('/global/cfs/cdirs/desi/users/rongpu/imaging_mc/mc/20230201/mc_elg_randoms_elgmask_v1_desi_ebv_zp_healpix_{}.fits'.format(nside), overwrite=True)
