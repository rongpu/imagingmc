...
for nside in [128, 256, 512]:
    ...
    hp_table.write('/global/cfs/cdirs/desi/users/rongpu/imaging_mc/mc/20230201/mc_elg_randoms_elgmask_v1_desi_ebv_z_0.8_1.1_healpix_{}.fits'.format(nside), overwrite=False)
