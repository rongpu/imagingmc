...
# python mc_elg-redshift_bin-different_randoms.py --zmin 0.8 --zmax 1.1
# python mc_elg-redshift_bin-different_randoms.py --zmin 1.1 --zmax 1.6
...
hpx_output_dir = '/global/cfs/cdirs/desi/users/rongpu/imaging_mc/mc/20240513-redshift_bin-different_randoms'
...
randoms_paths = sorted(glob.glob('/dvs_ro/cfs/cdirs/desi/users/rongpu/imaging_mc/trimmed_randoms/randoms-[0-9]*-trim.fits'))[:35][::-1]
