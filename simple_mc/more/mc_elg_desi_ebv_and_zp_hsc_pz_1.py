...
tmp_dir = '/pscratch/sd/r/rongpu/imaging_mc/tmp9/'
...
for nside in [128, 256, 512]:
    ...
    hp_table.write('/global/cfs/cdirs/desi/users/rongpu/imaging_mc/mc/20230201/mc_elg_randoms_elgmask_v1_desi_ebv_and_zp_z_1.1_1.6_healpix_{}.fits'.format(nside), overwrite=False)
